...
const mockSaveOnboardingDraft = jest.fn<Promise<void>, unknown[]>(
  async () => undefined,
);
const mockGetOnboardingDraft = jest.fn<
  ...
  unknown[]
>(async () => null);
const mockClearOnboardingDraft = jest.fn<Promise<void>, unknown[]>(
  async () => undefined,
);
const mockCreateMission = jest.fn<Promise<void>, unknown[]>(
  async () => undefined,
);
