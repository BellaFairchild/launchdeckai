...
export const MILESTONE_TEMPLATES: Omit<Milestone, "completed" | "isLocked">[] = [
  ...
  // Store Prep
  { id: "ms_store_desc", title: "Write App Store description", description: "Compelling store copy that converts.", category: "store", fuelReward: 20, requiredPlan: "cadet", linkedTool: "app_store_copy" },
  ...
  // Assets
  { id: "ms_social", title: "Generate a Social Blast", description: "Launch announcement posts.", category: "assets", fuelReward: 20, requiredPlan: "cadet", linkedTool: "social_blast" },
  { id: "ms_video", title: "Create a launch video script", description: "High-conversion hook + voiceover.", category: "assets", fuelReward: 25, requiredPlan: "commander", linkedTool: "video_script" },
  { id: "ms_presskit", title: "Build a press kit", description: "Everything media needs in one place.", category: "assets", fuelReward: 25, requiredPlan: "commander", linkedTool: "press_kit" },

  // Marketing
  { id: "ms_email", title: "Draft a launch email sequence", description: "Tease, launch, follow-up.", category: "marketing", fuelReward: 20, requiredPlan: "cadet", linkedTool: "email_sequence" },
  { id: "ms_ph", title: "Prepare Product Hunt copy", description: "Tagline, description, first comment.", category: "marketing", fuelReward: 20, requiredPlan: "commander", linkedTool: "product_hunt_copy" },
  { id: "ms_signal", title: "Stage your Signal Deck sequence", description: "Know what to post, when, where.", category: "marketing", fuelReward: 15, requiredPlan: "cadet", linkedTool: "signal_deck" },
  ...
  // Post-Launch
  { id: "ms_thankyou", title: "Send a thank-you email", description: "Thank early adopters.", category: "post_launch", fuelReward: 15, requiredPlan: "cadet", linkedTool: "email_sequence" },
